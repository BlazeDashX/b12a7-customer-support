    ...
    <div className="flex gap-5 pt-15">
      <div className="relative h-64 flex-1 overflow-hidden rounded-xl bg-linear-to-r from-[#7038E0] to-[#9F5CF0]">
        ...
        <img
          src={leftImg}
          alt=""
          className="absolute left-0 top-0 w-3/7 h-full "
        />

        <img
          src={leftImg}
          alt=""
          className="absolute right-0 bottom-0 w-3/7 h-full scale-x-[-1]"
        />
        ...
        <div className="relative h-64 flex-1 overflow-hidden rounded-xl bg-linear-to-r from-[#56D067] to-[#0D8372]">
